...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _successImage = [UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"tick" ofType:@"png"]];
        _errorImage = [UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"cross" ofType:@"png"]];
